...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(e)
      : ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).ShadeMap =
          e());
})(this, function () {
  "use strict";
  function t(t, e, r) {
  ...
  ((o.prototype = {
    ...
    (a.prototype = {
      ...
      contains: function (t) {
        ...
        return (
          (t =
            "number" == typeof t[0] || t instanceof o ? n(t) : s(t)) instanceof
          a
            ? ((e = t.min), (r = t.max))
            : (e = r = t),
          e.x >= this.min.x &&
    ...
    (u.prototype = {
      ...
      contains: function (t) {
        t =
          "number" == typeof t[0] || t instanceof c || "lat" in t ? f(t) : l(t);
        var e,
          r,
          o = this._southWest,
          i = this._northEast;
  ...
  var h = (function (t) {
    ...
    {},
    {
      ...
      wrapLatLng: function (e) {
        ...
        return new c(
          this.wrapLat ? t(e.lat, this.wrapLat, !0) : e.lat,
          r,
          e.alt,
        );
      },
    ...
    g = (t) => {
      const e = t / 864e5 - 10957.5,
        ...
        o =
          ...
          1.796593062783907 +
          Math.PI,
        i = Math.atan2(Math.sin(o) * Math.cos(m), Math.cos(o));
      return {
        dec: Math.asin(Math.sin(m) * Math.sin(o)),
        Hi:
          ((4.889714432387314 + 6.3003876824396166 * e - i) % (2 * Math.PI)) +
          2 * Math.PI,
      };
    },
    x = () => Math.floor(1e7 * Math.random()),
    p = (t, e, r) => {
      const o = 1 / e,
      ...
      return (
        i + n + a !== 0 &&
          (s =
            i > 0 ? (i / 255) * 0.5 + 0.5 : a > 0 ? 0.5 * (1 - a / 255) : 0.5),
        s * r
      );
    },
    E = (t = new Date(), e) => {
    ...
    return {
      project: (r, i) => {
        if (e()) return t.project(r, i);
        {
          const { lat: t, lng: e } = r;
          return new o(
            ((t, e) => ((t + 180) / 360) * Math.pow(2, e) * d)(e, i),
            ((t, e) =>
              ((1 -
                Math.log(
      ...
      unproject: (r, o) => {
        return e()
          ...
          : new c(
              ((i = r.y),
              (n = o),
              (a = Math.PI - (2 * Math.PI * i) / d / Math.pow(2, n)),
              (180 / Math.PI) * Math.atan(0.5 * (Math.exp(a) - Math.exp(-a)))),
              (function (t, e) {
                return (t / d / Math.pow(2, e)) * 360 - 180;
              })(r.x, o),
            );
        var i, n, a;
      },
  ...
  function y(t, e, r) {
        ...
        (f = (function (t, e, r, o) {
          ...
          for (i = 0, n = e.length; i < n; i++)
            ((a = A(
              ...
              s.push(P(a)));
          for (s.sort(L), i = 0; i < s.length; i++) r = U(s[i], r);
          return r;
        })(t, e, f, r)),
      t.length > 80 * r)
    ) {
    ...
    return (R(f, d, r, o, i, l, 0), d);
  }
  function A(t, e, r, o, i) {
    var n, a;
    if (i === K(t, e, r, o) > 0)
      for (n = e; n < r; n += o) a = j(n, t[n], t[n + 1], a);
    else for (n = r - o; n >= e; n -= o) a = j(n, t[n], t[n + 1], a);
    return (a && O(a, a.next) && (Y(a), (a = a.next)), a);
  }
  function b(t, e) {
    if (!t) return t;
    e || (e = t);
    ...
    do {
      if (
        ((r = !1), o.steiner || (!O(o, o.next) && 0 !== N(o.prev, o, o.next)))
      )
        o = o.next;
      else {
        if ((Y(o), (o = e = o.prev) === o.next)) break;
        r = !0;
      }
    } while (r || o !== e);
    return e;
  }
  function R(t, e, r, o, i, n, a) {
    if (t) {
      !a &&
        n &&
        (function (t, e, r, o) {
      ...
      for (var s, u, l = t; t.prev !== t.next; )
        if (((s = t.prev), (u = t.next), n ? w(t, o, i, n) : M(t)))
          (e.push((s.i / r) | 0),
            e.push((t.i / r) | 0),
            e.push((u.i / r) | 0),
            Y(t),
  ...
  function U(t, e) {
    var r = (function (t, e) {
      ...
      do {
        (i >= o.x &&
          o.x >= h &&
          i !== o.x &&
          I(n < c ? i : a, n, h, c, n < c ? a : i, n, o.x, o.y) &&
          ((u = Math.abs(n - o.y) / (i - o.x)),
          H(o, t) &&
            (u < f || (u === f && (o.x > r.x || (o.x === r.x && S(r, o))))) &&
            ((r = o), (f = u))),
          (o = o.next));
      } while (o !== l);
      return r;
    ...
    if (!r) return e;
    var o = W(r, t);
    return (b(o, o.next), b(r, r.next));
  }
  function S(t, e) {
    return N(t.prev, t, e.prev) < 0 && N(e.next, t, t.next) < 0;
  }
  ...
  function B(t, e) {
    return (
      ...
      ((H(t, e) &&
        ...
        (N(t.prev, t, e.prev) || N(t, e.prev, e))) ||
        (O(t, e) && N(t.prev, t, t.next) > 0 && N(e.prev, e, e.next) > 0))
    );
  }
  function N(t, e, r) {
  ...
  function H(t, e) {
    return N(t.prev, t, t.next) < 0
      ? N(t, e, t.next) >= 0 && N(t, t.prev, e) >= 0
      : N(t, e, t.prev) < 0 || N(t, t.next, e) < 0;
  }
  function W(t, e) {
    var r = new Z(t.i, t.x, t.y),
      o = new Z(e.i, e.x, e.y),
      i = t.next,
      n = e.prev;
    return (
    ...
    return t
      ...
      .map((t) => {
        const { geometry: e, properties: r } = t,
          ...
          n = y(o.vertices, o.holes, o.dimensions),
  ...
  ((y.deviation = function (t, e, r, o) {
    var i = e && e.length,
      n = i ? e[0] * r : t.length,
      a = Math.abs(K(t, 0, n, r));
    if (i)
      for (var s = 0, u = e.length; s < u; s++) {
        var l = e[s] * r,
          h = s < u - 1 ? e[s + 1] * r : t.length;
        a -= Math.abs(K(t, l, h, r));
      }
    var c = 0;
  ...
  const V = (t, e) => {
      const { lat: r, lng: i } = t;
      return new o(
        ((t, e) => ((t + 180) / 360) * Math.pow(2, e) * d)(i, e),
        ((t, e) =>
          ((1 -
            Math.log(
    ...
    q = (t, e) => {
      return new c(
        ((r = t.y),
        (o = e),
        (i = Math.PI - (2 * Math.PI * r) / d / Math.pow(2, o)),
      ...
      T(void 0, void 0, void 0, function* () {
        ...
        try {
          const t = c,
            ...
            i = t.getSouthEast(),
            T = new a(V(r, e), V(i, e));
          let y = new o(T.min.x, T.min.y),
            b = T.max.x - T.min.x;
          const R = T.max.y - T.min.y,
            M = T.max.subtract(T.min);
          M.y > M.x && ((y.x -= d), (b += 512));
          const w = ((t) => {
              const { upperLeft: e, width: r, height: o } = t,
                i = e.divideBy(d).floor().multiplyBy(d),
                n = (Math.ceil(r / d) + 1) * d,
                s = (Math.ceil(o / d) + 1) * d,
                u = i.add([n, s]);
              return new a(i, u);
            })({ upperLeft: y, width: b, height: R }),
            { x: F, y: D } = w.max.subtract(w.min),
            L = ((t) => {
              ...
              ((t) => {
                const { upperLeft: e, width: r, height: o, zoom: i } = t,
                  n = e.divideBy(d).floor(),
                  a = n.x + r / d,
                  s = Math.min(n.y + o / d, Math.pow(2, i) - 1),
                  u = [];
                for (var l = n.x; l < a; l++)
                  for (var h = n.y; h < s; h++) u.push({ x: l, y: h, z: i });
                return u;
              })({ upperLeft: w.min, width: F, height: D, zoom: e }),
            ),
            U = T.max.x - T.min.x,
            S = T.max.y - T.min.y,
            C = Math.round(U),
          ...
          const X = new a(
              V(new u(s.bounds).getNorthWest(), e),
              V(new u(s.bounds).getSouthEast(), e),
            ),
            z = X.min.subtract(w.min),
            G = X.max.subtract(w.min),
            H = [z.x / F, z.y / D, G.x / F, G.y / D].map((t) => 2 * t - 1),
            W = yield A,
            { maxHeight: j, heightMapTex: Y } = f.raster({
              upperLeftTile: L[0],
              width: F,
              height: D,
              mapZoom: e,
            ...
            Z = Math.max(s.maxHeight, N.maxHeight + j);
          (($ = I),
            (J = {
              heightMapTex: Y,
              maxHeight: Z,
    ...
    it = (t) => {
      ...
      try {
        const {
          ...
          height: g,
          DEMPixelBounds: x,
          visibleDEMPixelBounds: p,
          demZoom: E,
        } = o;
        if (0 === m || 0 === g) return;
        const { min: v, max: T } = p;
        if (!v || !T) return;
        const { x: y, y: A } = T.subtract(v),
          b = x.min,
          R = r.getPixelDimensions(),
          M = r.screenUnproject([0, 0]),
          w = r.screenUnproject([R.width, 0]),
          F = r.screenUnproject([R.width, R.height]),
          D = r.screenUnproject([0, R.height]),
          L = [D, F, M, w].map((t) => r.project(t, E)),
          U = L.map((t) => [(t.x - b.x) / m, (t.y - b.y) / g]).flat(),
          S = L.map((t) => [(t.x - v.x) / y, (t.y - v.y) / A])
            .map((t) => [
              2 * t[0] - 1,
              (2 * t[1] - 1) * (r.isLeaflet() ? -1 : 1),
            ])
            .flat(),
          C = b.y / d / Math.pow(2, E),
          P = g / d / Math.pow(2, E),
          I = new u(q(x.getTopLeft(), E), q(x.getBottomRight(), E)),
          B = I.getWest(),
          N = Math.abs(I.getWest() - I.getEast());
        ((t, e) => {
  ...
  class st {
    constructor(t) {
      ((this.gl = t),
        ...
        (this.colorUniformLocation = t.getUniformLocation(
          this.program,
          "color",
        )),
    ...
    raster(t) {
      ...
      const T = f / Math.pow(2, _),
        y = m / Math.pow(2, _),
        A = new o(T, y),
        b = n / d / Math.pow(2, _),
        R = a / d / Math.pow(2, _);
      (c.uniform3f(this.xyzUniformLocation, T, y, _),
        c.uniform2f(this.dimensionsUniformLocation, b, R),
      ...
      const M = new Float32Array([-1, -1, 1, -1, -1, 1, 1, 1]);
      if (
        ...
        e
          ...
          .forEach((t) => {
            ...
            const h = l.x / n,
              ...
              _ = Math.floor(d % 255) / 255;
            ((g = Math.max(g, e)),
              c.uniform2f(this.centroidUniformLocation, h, f),
              c.uniform4f(this.colorUniformLocation, m, _, m, _),
      ...
      return (
        ...
        { maxHeight: g, heightMapTex: this.targetTexture }
      );
    }
  }
  const ut = (t) => {
    ...
    return {
      x: o === d ? i : Math.floor(i / 2),
      y: o === d ? n : Math.floor(n / 2),
      z: o === d ? a : a - 1,
    };
  };
  class lt {
    ...
    merge(t, e) {
      return T(this, void 0, void 0, function* () {
        ...
        if (r) {
          ...
          const e = new Set();
          (t.forEach((t) => {
            e.add(s(ut({ tile: t, maxZoom: c, tileSize: l })));
          }),
          ...
          const m = r.createFramebuffer();
          (r.bindFramebuffer(r.FRAMEBUFFER, m),
          ...
          const _ = r.checkFramebufferStatus(r.FRAMEBUFFER);
          (_ !== r.FRAMEBUFFER_COMPLETE &&
            console.error("Framebuffer is incomplete: " + _),
            r.clear(r.COLOR_BUFFER_BIT));
          const g = Array.from(e).map((e) =>
              ...
              return new Promise((u, h) => {
                ...
                (this.inProgress.push(f),
                  (f.onload = () => {
                    ...
                    const a = t.filter(
                        (t) =>
                          e === s(ut({ tile: t, maxZoom: c, tileSize: l })),
                      ),
                      h = a.reduce((t, e) => Math.min(t, e.xOffset), 1 / 0),
                      _ = a.reduce((t, e) => Math.min(t, e.yOffset), 1 / 0),
                      g = a.reduce((t, e) => Math.max(t, e.xOffset), 0),
                      x = a.reduce((t, e) => Math.max(t, e.yOffset), 0),
                      p = a.reduce((t, e) => Math.min(t, e.x), 1 / 0),
                      E = a.reduce((t, e) => Math.min(t, e.y), 1 / 0),
                      v = a.reduce((t, e) => Math.max(t, e.x), 0),
                      T = a.reduce((t, e) => Math.max(t, e.y), 0),
                      y = a[0].z,
                      A = h / i,
                      b = _ / n,
                      R = (g + d) / i,
                    ...
                    const D = Math.pow(
                      ...
                      P = (v % D) / D,
                      I = (T % D) / D;
                    ((F = [S, C, P + U, C, S, I + U, P + U, I + U].map(
                      (t) => t * (514 === l ? 512 / 514 : 1) + L,
                    )),
                    ...
                    const B = Math.floor(A * i),
                      N = Math.floor(b * n),
                      O = Math.ceil((R - A) * i),
                      X = Math.ceil((M - b) * n),
                      z = new Uint8Array(4 * O * X);
                    r.readPixels(B, N, O, X, r.RGBA, r.UNSIGNED_BYTE, z);
                    for (let t = 0; t < z.length; t += 4) {
                      const e = (256 * z[t + 2] + z[t + 3]) / 5;
                      o = Math.max(e, o);
                    }
                    u(null);
                  }),
          ...
          try {
            ...
            return (console.log(`${g.length} requests aborted`, t), null);
          }
          return (
            (this.inProgress = []),
  ...
  return class extends class extends class {
    ...
    constructor(...t) {
      ...
      const e = t[0];
      if (
        ((this.options = Object.assign(this.options, e)), !this.options.apiKey)
      )
        ...
        this.options.date.getTime() !== t.getTime()
          ? ((this.options.date = t),
            this._compiledKernel &&
              (et(this._compiledKernel, { date: this.options.date }),
    ...
    _setDateForTimezone(t, e) {
      let r = 0;
      (e && (r = E(this.options.date) - E(this.options.date, e)),
    ...
    setSunExposure(t = !1, e) {
      return T(this, void 0, void 0, function* () {
        ...
        if (this._map && this._compiledKernel && this._heightMap) {
          if (!1 === t) et(this._compiledKernel, { date: this.options.date });
          else {
            const {
              startDate: t,
              endDate: e,
    ...
    _getBounds(t, e) {
      ...
      const n = t.getCenter(),
        a = V(n, e),
        s = q(new o(a.x - r / 2, a.y - i / 2), e),
        u = q(new o(a.x + r / 2, a.y + i / 2), e);
          ...
          try {
            if (!t.isLeaflet() && this._map.getPitch() > 45) {
              ...
              const r = this._map.style._sourceCaches["other:composite"]
                ...
                h = q(new o(512 * a, 512 * s), i + 1),
                c = q(new o(512 * (u + 1), 512 * (l + 1)), i + 1);
    ...
    toGeoTiff() {
      const t = (t, e) => {
        ...
        if (this._map && !v(this._map).isLeaflet()) return a;
    ...
    _generateLocationShadeProfile(t) {
      if (this._compiledKernel) {
        const e = E(t.startDate) - E(t.startDate, t.tzId),
    ...
    constructor(t) {
      (super(t),
        ...
        (this._raf = 0),
        (this.id = this.id + x()),
        (this.canvasSourceId = this.canvasSourceId + x()),
        (this.attributionSourceId = this.attributionSourceId + x()),
        (this.canvasLayerId = this.canvasLayerId + x()),
        (this.attributionLayerId = this.attributionLayerId + x()),
    ...
    onAdd(t) {
      ...
      ((this._compiledKernel = (function (t) {
        ...
        const f = o.getUniformLocation(i, "user_width"),
          d = o.getUniformLocation(i, "user_height"),
          m = o.getUniformLocation(i, "user_maxHeight"),
          x = o.getUniformLocation(i, "user_zoom"),
          p = o.getUniformLocation(i, "user_topYCoord"),
          v = o.getUniformLocation(i, "user_ySize"),
        ...
        const K = (t) => {
          ...
          if (
            ...
            const i = [],
              ...
              a = E(new Date(j), Z);
            for (let t = 0; t < e; t++) {
              const e = E(new Date(j + 86400 * t * 1e3 + n), Z) - a;
              i[t] = e;
            }
              ...
              for (let t = 0; t < l; t++) {
                ...
                yield new Promise((r, h) => {
                  window.requestAnimationFrame(() => {
                    ...
                    const { dec: c, Hi: d } = _(new Date(e.getTime() + f * t));
                    (o.uniform1f(R, c),
                      o.uniform1f(M, d),
        ...
        (this._tileMerger = new lt(this._gl)),
        (this._canopyMerger = new lt(this._gl)),
        (this._buildingRasterizer = new st(this._gl)),
      ...
      return (
        ...
        t.addSource(this.attributionSourceId, {
          ...
          attribution:
            '<a href="https://shademap.app/about">&copy; ShadeMap</a>',
        }),
        t.addLayer({
    ...
    _getHeightMapCoords(t, e) {
      if (
        ...
        return v(this._map).project(r, n).subtract(i.min);
      }
      return new o(-1, -1);
    }
    getHoursOfSun(t, e) {
    ...
    _flush() {
      if (this._map) {
        this._map.getSource(this.canvasSourceId).fire({
          type: "data",
          dataType: "source",
